...
<div class="wrap ccm-page"> 
  ...
  <div class="breadcrumb">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12"> Du är här : <span class="active">Kontakt</span> </div>
      </div>
    </div>
  </div>
  <!-- Breadcrumbs Ends --> 
              ...
              <div class="col-md-8 col-md-offset-2">
                <form action="thanks.php" method="post" name="contact" id="contact" onSubmit="return validate_contact(this)">
                  <div class="form-group">
                    <select name="arende" id="arende"  class="form-control">
                      <option value="0">Ärende</option>
                      <option value="Tidsbokning">Tidsbokning</option>
                      <option value="Undersökning">Undersökning</option>
                      <option value="Återbud">Återbud</option>
                      <option value="Betalningar">Betalningar</option>
                      <option value="Ring mig">Ring mig</option>
                      <option value="Annat">Annat</option>
                    </select>
                  </div>
                  <div class="form-group">
                    <select name="valj" id="valj"  class="form-control">
                  ...
                  <div class="form-group">
                    <textarea class="form-control" id="meddelande" name="meddelande" rows="5" placeholder="Meddelande*"></textarea>
                  </div>
                  <div class="form-group">
