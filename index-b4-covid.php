...
<!-- End Google Tag Manager (noscript) -->
        ...
        <section class="banner">
            <div class="container">
                <div class="flex-container justifyCenterSmall">
                    <div class="banner-content">
                        <p class="text-brown font-20 mb2">Bandhagen Dental Care Erbjuder allmän</p>
                        <h2 class="font-caladea text-green">Allmän Traditionell Tandvård</h2>
                        <h2 class="font-caladea text-green mb1">Och Estetisk Tandvård</h2>
                        <p class="text-brown font-20 mb6">till ett vackert leende samt kirurgisk behandling för bl.a implantat</p>
                        <div class="banner-btns mb2">
                            <div class="border-left-trns">
                                <p class="mb1">Kontakta oss genom att ringa</p>
                                <p class="text-brown font-caladea font-30">(08)-647 86 20 / (073)-75 75 755</p>
                            </div>
                        </div>
                        <div class="banner-btns banner-btn2">
                            <div class="border-left-trns">
                                <p class="mb1">Kontakta din klinik</p>
                                <p class="text-brown font-caladea font-30">Bandhagen / Hässelby</p>
                            </div>
                        </div>
                    </div>
                    <div class="banner-image">
                        <!--<div class="banner-image-width">-->                            
                        <img src="images/image_banner.png">
                        <!--</div>-->
                    </div>
                </div>
            </div>
                ...
                <div class="side-content">
                    <div class="flex-column max660">
                        ...
                        <div class="links-white">
                            <a href="">Boka Online pa Din Klinik</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="testimonial-slider" class="owl-carousel">
                    <div class="testimonial">
                        <p class="description mb3">
                            Fantastisk tandläkarmottagning. Lugn atmosfär i kombination med kompetenta och supertrevliga tandläkare. Varmt rekommenderas!
                        </p>
                        ...
                        <p class="testimonial-title">John Doe</p>
                        <p class="text-white">Elkins Park, Hässelby Stockholm</p>
                    </div>
                    <div class="testimonial">
                        <p class="description mb3">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. tempus vel ultricies viverra, luctus in elit. Aliquam tempus blandit velit.
                        </p>
                        <p class="text-brown mb6 text12">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
