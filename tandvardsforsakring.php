...
<div class="wrap ccm-page">
  ...
  <div class="breadcrumb">
  	<div class="container-fluid">
    	<div class="row">
        	<div class="col-md-12">
            	Du är här : Priser / <span class="active">Tandvårdsförsäkring</span>            	
            </div>
        </div>
    </div>
  </div>
    ...
    <section>
      <div class="container margin-btm40">
        <div class="row margin-btm40">
          <div class="col-md-12">
            <h1 class="text-center">Tandvårdsförsäkring</h1>
          </div>
        </div>
...
<br>
Ett skydd för höga kostnader för tandvårdstjänster införs. Upp till 3 000 kronor står du för hela beloppet. Kostnader mellan 3 000 - 15 000 kronor ersätts med 50 procent och kostnader över 15 000 kronor ersätts med 85 procent.<br>
<br>
